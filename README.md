...
- As a user, I want to be able to save the state of the card game to file
- As a user, I want to be able to load the state of the card game I last played from file
